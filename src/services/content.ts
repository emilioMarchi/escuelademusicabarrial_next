...
/**
 * Obtiene la configuración de una página (inicio, nosotros, etc) por su slug con CACHE.
 */
export const getPageBySlug = unstable_cache(
  async (slug: string): Promise<PageWithSections | null> => {
...
/**
 * Busca un elemento (Clase o Noticia) por su slug (título formateado) con CACHE.
 */
export const getElementBySlug = unstable_cache(
  async (slug: string): Promise<(Class | News | any) | null> => {
    if (!slug) return null;
